...
export const imageUpload = async (req, res, next) => {
  try {
    ...
    const imageUrl = `https://travel-book-frontend.vercel.app/uploads/${req.file.filename}`;
...
export const editTravelStory = async (req, res, next) => {
  ...
  try {
    ...
    const placeholderImageUrl = `https://travel-book-frontend.vercel.app/assets/placeholderImage.png`;
